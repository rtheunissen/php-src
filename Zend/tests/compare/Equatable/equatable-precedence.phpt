...
$obj1 == $obj1;
$obj1 == $obj2;
$obj1 == $eq1;      // Use eq1 equals
$obj1 == $cmp1;     // Use cmp1 equals

echo PHP_EOL;
$eq1 == $obj1;      // Use eq1 equals
$eq1 == $eq1;
$eq1 == $eq2;       // Use eq1 equals
$eq1 == $cmp1;      // Use eq1 equals

echo PHP_EOL;
$cmp1 == $obj1;    // Use cmp1 equals
$cmp1 == $cmp1;
$cmp1 == $cmp2;    // Use cmp1 equals
$cmp1 == $eq1;     // Use cmp1 equals
...
echo PHP_EOL;
$eq1 == new DateTime();   // Use eq1 equals
new DateTime() == $eq1;   // Use eq1 equals
